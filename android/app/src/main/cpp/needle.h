/*
 * needle.h - public C API of the Needle engine.
 *
 * Copyright (c) Cactus Compute, Inc. Licensed under the Apache License 2.0.
 * Source: https://huggingface.co/Cactus-Compute/needle3 (android-<abi>/needle.h)
 *         https://github.com/cactus-compute/needle
 *
 * Vendored here so the JNI bridge compiles without a network round trip for a
 * 1 KB header. Keep it byte-identical to the published header when upgrading.
 */
#ifndef NEEDLE_H
#define NEEDLE_H
